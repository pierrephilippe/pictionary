...
| --- | --- | --- |
| Choix initial clair | Deux zones égales, création puis jonction : superposées sur mobile ou en portrait, côte à côte sur desktop paysage. Le shell responsive 50/50 est réutilisé sur les écrans applicatifs hors dessin. | CSS et composants ; contrôle visuel multi-appareils requis. |
