...
- Création : demander uniquement une difficulté, le nombre de manches et la durée par manche. La difficulté est un choix exclusif entre Facile, Moyen et Difficile, jamais cumulable. Ne proposer ni thème ni bouton ambigu « Enregistrer »; le CTA lance avec les réglages affichés.
- Préparation : dans la première moitié, placer QR code et lien direct, puis un pied toujours visible avec l'état du projecteur, l'état du téléphone de dessin et le démarrage. La seconde moitié expose des accès compacts à l'édition des joueurs et aux réglages, chacun dans une modale. La modale Joueurs conserve sa taille lors des ajouts et sa liste défile à l'intérieur si nécessaire. Tant qu'il n'y a aucun joueur, mettre en évidence l'accès Joueurs avec une animation prononcée et un compteur très lisible; lorsque toutes les conditions sont réunies, faire de même pour Démarrer la partie. Le démarrage exige un projecteur connecté et un autre téléphone connecté en mode dessin; annoncer chaque présence sans dépendre de la couleur.
- Le contrôleur peut supprimer définitivement sa salle, après confirmation explicite. L'action déconnecte tous les téléphones, redirige le contrôleur vers l'accueil après confirmation serveur et ne doit jamais être présentée comme une simple sortie de la salle.
